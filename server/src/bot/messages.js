...
const messages = {
  uz: {
    ...
    pendingVerification: "📸 Pasport rasmingiz adminga yuborildi!\n\nAdmin uni ko'rib chiqib, sizni tasdiqlaydi. Iltimos, sabr bilan kuting — tasdiqlangandan so'ng sizga xabar beriladi. 🙏",
  ...
  ru: {
    ...
    pendingVerification: '📸 Фото вашего паспорта отправлено администратору!\n\nАдминистратор рассмотрит его и подтвердит вас. Пожалуйста, ожидайте — после подтверждения вы получите уведомление. 🙏',
  ...
  en: {
    ...
    pendingVerification: '📸 Your passport photo has been sent to the admin!\n\nThe admin will review it and verify you. Please wait patiently — you will be notified once verified. 🙏',
